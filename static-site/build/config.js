...
export const QUIZ_FEATURED = {
  ...
  testSuisJeAmoureux:{ file: 'daisy-petals',              old: null,                  alt: { fr: "Une marguerite posée sur une table en bois clair, la moitié de ses pétales déjà effeuillés et éparpillés à côté", en: 'A daisy lying on a pale wooden table, half of its petals already plucked and scattered beside it', es: 'Una margarita sobre una mesa de madera clara, con la mitad de los pétalos ya arrancados y esparcidos al lado', de: 'Ein Gänseblümchen auf einem hellen Holztisch, die Hälfte der Blütenblätter schon abgezupft und daneben verstreut', it: 'Una margherita su un tavolo di legno chiaro, con metà dei petali già sfogliati e sparsi accanto' } },
  ...
  testAimeEncore:    { file: 'two-mugs-one-cold',           old: null,                  alt: { fr: "Deux tasses de café sur une table de cuisine : l'une fume encore, l'autre a refroidi sans être touchée", en: 'Two coffee mugs on a kitchen table: one still steaming, the other gone cold, untouched', es: 'Dos tazas de café en una mesa de cocina: una todavía humea, la otra se ha enfriado sin tocar', de: 'Zwei Kaffeetassen auf einem Küchentisch: eine dampft noch, die andere ist unberührt kalt geworden', it: "Due tazze di caffè su un tavolo di cucina: una fuma ancora, l'altra si è raffreddata senza essere toccata" } },
  ...
  testTrouverAmour:  { file: 'compass-heart-map',           old: null,                  alt: { fr: "Une boussole en laiton ouverte sur une nappe en lin, l'aiguille remplacée par un petit cœur rose, à côté d'une tasse de café et d'une carte pliée", en: 'An open brass compass on a linen tablecloth, its needle replaced by a small pink heart, next to a cup of coffee and a folded map', es: 'Una brújula de latón abierta sobre un mantel de lino, con la aguja sustituida por un pequeño corazón rosa, junto a una taza de café y un mapa doblado', de: 'Ein geöffneter Messingkompass auf einer Leinentischdecke, die Nadel durch ein kleines rosa Herz ersetzt, neben einer Kaffeetasse und einer gefalteten Karte', it: "Una bussola di ottone aperta su una tovaglia di lino, con l'ago sostituito da un piccolo cuore rosa, accanto a una tazza di caffè e a una mappa piegata" } },
