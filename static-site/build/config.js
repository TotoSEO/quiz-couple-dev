...
export const QUIZ_FEATURED = {
  ...
  jeuxCouple:        { file: 'fun-confetti',              old: null,                  alt: { fr: 'Confettis et ballons de fête pour une soirée jeux en couple', en: 'Confetti and party balloons for a couple game night', es: 'Confeti y globos de fiesta para una noche de juegos en pareja', de: 'Konfetti und Luftballons für einen Spieleabend zu zweit', it: 'Coriandoli e palloncini per una serata di giochi in coppia' } },
