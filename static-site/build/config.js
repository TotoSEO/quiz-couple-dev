...
export const QUIZ_FEATURED = {
  ...
  testAimeEncore:    { file: 'heart-on-window',            old: null,                  alt: { fr: "Un cœur dessiné du bout du doigt sur une vitre embuée, qui commence à s'effacer", en: 'A heart drawn with a fingertip on a fogged-up window, starting to fade', es: 'Un corazón dibujado con el dedo en un cristal empañado que empieza a borrarse', de: 'Ein mit dem Finger auf eine beschlagene Scheibe gezeichnetes Herz, das langsam verschwindet', it: "Un cuore disegnato con il dito su un vetro appannato, che comincia a sbiadire" } },
  testEmprise:       { file: 'jealousy-phone',             old: null,                  alt: { fr: "Un téléphone posé face contre la table, dont l'ombre s'étire comme une surveillance", en: 'A phone lying face down on a table, its long shadow stretching out like surveillance', es: 'Un teléfono boca abajo sobre la mesa, con una sombra alargada como una vigilancia', de: 'Ein Handy, das mit dem Display nach unten auf dem Tisch liegt und einen langen Schatten wirft, wie eine Überwachung', it: "Un telefono a faccia in giù sul tavolo, con un'ombra allungata come una sorveglianza" } },
