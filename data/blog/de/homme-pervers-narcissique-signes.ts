...
const article: BlogArticleData = {
  slug: 'narzisstischer-mann-anzeichen',
  title: "Narzisstischer Mann: 12 Anzeichen, vom öffentlichen Charme zur privaten Kontrolle",
  metaTitle: "Narzisstischer Mann: 12 Anzeichen vom Charme zur Kontrolle",
  metaDescription: "Nach außen makellos, zu Hause zermürbend. Die 12 Verhaltensweisen des narzisstischen Mannes, in der Reihenfolge ihres Auftretens, und was danach zu tun ist.",
...
<tr><td>Am Anfang, mit dir</td><td>Eine großartige Liebe auf den ersten Blick</td><td>Eine Intensität, die dir später als Anker dient</td></tr>
<tr><td>Im Privaten</td><td>Nichts, niemand ist dabei</td><td>Die Spitzen, die Vergleiche, die Schwelle, die zurückweicht</td></tr>
<tr><td>Wenn du dich wehrst</td><td>Eine Frau, die «schwierig wird»</td><td>Die Eskalation, die Umkehrung, die Schuld</td></tr>
</tbody></table></div>`,
      subsections: [
        {
          id: 'in-gesellschaft',
