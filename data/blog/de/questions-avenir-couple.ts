...
<li>Wie teilen wir die Aufgaben auf: nach Lust, nach Plan, nach Können?</li>
<li>Was ist dein idealer Rhythmus: Nachteule, Frühaufsteher, und wie verhandelt man das?</li>
<li>Freunde ohne Vorwarnung einladen: normal oder undenkbar?</li>
<li>Wie regeln wir die Alltagsausgaben, ab dem ersten Monat?</li>
<li>Was ist deine schlimmste Befürchtung beim Zusammenleben?</li>
<li>Wie viel eigenen Raum brauchst du in einer Wohnung?</li>
<li>Bildschirme im Schlafzimmer: ja, nein, kommt drauf an?</li>
<li>Wie gehen wir mit Streit um, wenn keiner mehr zu sich nach Hause kann?</li>
<li>Stadt oder Umland, mieten oder kaufen: Was ist dein ideales Szenario?</li>
...
<p>Wenn dich die Hälfte dieser Antworten überrascht, ist das kein schlechtes Zeichen, im Gegenteil: besser jetzt entdecken. Und um daraus eine überlegte Entscheidung zu machen, gleicht der <a href="/de/zusammenziehen-test-paare/">Test «bereit zusammenzuziehen»</a> eure Antworten Punkt für Punkt ab... das erspart, die Unterschiede erst mit ausgepackten Kisten zu entdecken.</p>`,
    ...
    {
      id: 'vor-der-bindung',
      title: "Vor der endgültigen Bindung (16-30)",
      content: `<p>Heirat, eingetragene Partnerschaft oder Bindung ohne Papiere: Egal in welcher Form, hier wird der Kern geprüft. Diese fünfzehn Fragen sind die, die Paare bereuen, sich nicht gestellt zu haben.</p>
<ol start="16">
<li>Was bedeutet Bindung für dich, konkret, nicht als Gedicht?</li>
<li>Heirat: Wunsch, Gleichgültigkeit oder Prinzip? Und warum?</li>
<li>Was ist deine größte Angst, dich an mich zu binden?</li>
<li>Was würde uns in vierzig Jahren zu einem gelungenen alten Paar machen?</li>
...
<p>Die 20 und die 26 verdienen einen eigenen Abend. Und wenn ihr durch seid, stellt der <a href="/de/ehe-kompatibilitaetstest/">Test «bereit für die Ehe»</a> eure Antworten einander gegenüber, schwarz auf weiß... es ist erstaunlich, was dabei herauskommt.</p>`,
    ...
    {
      id: 'vor-einem-kind',
      title: "Vor einem Kind (31-45)",
      content: `<p>Das verbindlichste Thema überhaupt, und das, bei dem das Unausgesprochene am teuersten wird. Diese Fragen stellt man nicht auf einmal, aber sie sollten alle vor dem großen Sprung gestellt worden sein.</p>
<ol start="31">
<li>Ein Kind: ein Plan mit Datum, ein vager Wunsch oder eine offene Frage?</li>
<li>Warum willst du ein Kind? Die echte Antwort, nicht die gesellschaftliche.</li>
<li>Und wenn es nicht auf natürlichem Weg käme... was würden wir tun, wie weit gehen?</li>
<li>Wer schränkt was ein, in den ersten Jahren: Arbeit, Ausgehen, Schlaf?</li>
...
<li>Wie definieren wir eine «große Ausgabe», die zu zweit besprochen wird?</li>
<li>Den Gehaltsunterschied zwischen uns, wie regeln wir den, ohne Tabu?</li>
<li>Welche Schuld oder finanzielle Verpflichtung von dir sollte ich kennen?</li>
<li>Sparen wofür, vorrangig: Wohnung, Reisen, Sicherheit, Rente?</li>
...
<li>Was wollen wir vor unserem 60. Lebensjahr zusammen erlebt haben?</li>
<li>Was ist unser nächstes großes Projekt, das, das wir dieses Jahr starten?</li>
<li>Und in sehr ferner Zeit... woran sollen sich die Leute bei uns beiden erinnern?</li>
</ol>
...
<tr><td>Vor einem Kind</td><td>Wer beruflich zurücksteckt, und wie lange</td></tr>
<tr><td>Das Geld</td><td>Das Verhältnis zum Ausgeben, aus jeder Familie geerbt</td></tr>
<tr><td>Die gemeinsamen Träume</td><td>Die, die man aufgehört hat, laut auszusprechen</td></tr>
</tbody></table></div>
