...
const article: BlogArticleData = {
  slug: 'narzisstische-frau-anzeichen',
  title: "Die narzisstische Frau: 10 Anzeichen, die Männer nicht auszusprechen wagen",
  metaTitle: "Narzisstische Frau: Symptome und typische Masken",
...
<p>Dieser Artikel arbeitet der Reihe nach: zuerst die Masken, denn sie sind ihre Signatur. Dann die 10 Anzeichen, konkret. Und am Ende, was du tun kannst, denn das Ziel ist nicht, ihr ein Etikett aufzukleben, sondern DICH aus dem Nebel zu holen.</p>`,
  quickSummary: [
    ...
    "Der Griff läuft weniger über Autorität als über Schuldgefühle und emotionale Kontrolle.",
    "Ihre stärkste Waffe: die Glaubwürdigkeit. Wenn du redest, bist du der Täter.",
    "Männer zweifeln doppelt: an dem, was sie erleben, und an ihrem Recht, darunter zu leiden. Auch dieser Zweifel gehört zum System.",
  ],
  sections: [
    {
      id: 'warum-niemand-darueber-spricht',
      title: "Warum nie darüber gesprochen wird (und warum ihr das passt)",
      content: `<p>Fangen wir beim Tabu an, denn es ist Teil des Problems. Ein Mann, der erzählt, dass seine Partnerin ihn kleinmacht, kontrolliert und an seinem Verstand zweifeln lässt, was hört er normalerweise zurück? «Sie hat eben Charakter!», «Bist du nicht ein bisschen dramatisch?», oder der große Klassiker: «Was hast du gemacht, dass sie so wird?»</p>
<p>Ergebnis: Männer schweigen. Und dieses Schweigen ist kein Detail, es ist ein Spielfeld. <strong>Eine Manipulatorin weiß genau, dass das Wort ihres Opfers weniger zählen wird als ihres.</strong> Das ist sogar, wie wir sehen werden, ein zentrales Stück ihres Systems.</p>
<p>Im Kern ist das Funktionieren identisch mit dem, was im Leitfaden zum <a href="/de/blog/narzisst-in-der-liebe/">Narzissten in der Liebe</a> beschrieben wird: ein strukturelles Bedürfnis zu dominieren, um zu existieren, der andere als Treibstoff, der Zyklus aus Idealisierung, Abwertung und Verstoßung. Was sich ändert, ist die Verpackung, und die lohnt den Umweg.</p>`,
    },
    {
      id: 'ihre-masken',
...
<tr><td>In sozialen Netzwerken</td><td>Traumpaar, Liebeserklärungen, vertraute Fotos</td><td>Der Fotoabend endete in einer Szene, aber das wird niemand erfahren</td></tr>
<tr><td>Im Konflikt</td><td>Gerührt, maßvoll, «besorgt um dich»</td><td>Verächtlich, schneidend, dann tagelang eisiges Schweigen</td></tr>
</tbody></table></div>
<p>Du siehst die Falle: An dem Tag, an dem du erzählen willst, was du erlebst, hat dein ganzes Umfeld die öffentliche Version kennengelernt. Und gegen SIE wird dein Wort ankämpfen müssen.</p>`,
    },
    {
      id: 'die-10-anzeichen',
...
<p>Normal: Die Hälfte steht schon, in weniger systematischer Form, bei den <a href="/de/blog/red-flags-bei-einer-frau/">Red Flags bei einer Frau</a>. Der Unterschied liegt in Intensität und Kohärenz: Eine einzelne Red Flag ist ein Makel. Zehn Red Flags, die auf deine Kontrolle und deine Isolation zulaufen, sind ein System.</p>
</aside>`,
    },
    {
...
<div class="blog-cta">
<p class="blog-cta-titre">Finde ruhige Worte für das, was du erlebst</p>
<p class="blog-cta-texte">Zwanzig Fragen gehen die konkreten Situationen dieser Art von Beziehung durch, in beide Richtungen: Sie gelten für eine Partnerin genauso wie für einen Partner. Antworte in Ruhe, für dich. Niemand erfährt davon.</p>
<a class="blog-cta-btn" href="/de/narzisstischer-partner-test/">Diskret Bilanz ziehen</a>
<p class="blog-cta-note">Kostenlos &middot; Ohne Anmeldung &middot; Sofortiges Ergebnis</p>
</div>
<aside class="blog-tip-box">
<p class="blog-tip-box-title">⚠️ Es gibt auch Hilfetelefone für Männer</p>
<p>Wird oft übersehen: In Deutschland gibt es das Hilfetelefon Gewalt an Männern unter 0800 123 99 00, kostenlos und vertraulich, und psychische Gewalt gehört ausdrücklich dazu. Bei Drohungen, Kontrolle über dein Geld oder deine Wege oder körperlicher Gewalt «auch nur einmal»: ruf an. Bei unmittelbarer Gefahr: 110. Eine Therapeutin oder ein Therapeut mit Erfahrung in psychischer Gewalt geht den Rest des Weges mit dir.</p>
</aside>
<p>Ein letztes Wort zum Ausstieg: Bei diesem Profil sieht eine Trennung nicht aus wie eine normale Trennung. Spektakuläre Rückeroberung, Rufmordkampagne, zyklische Rückkehr. Die <a href="/de/blog/trennung-von-einem-narzissten/">Trennung von einem Narzissten</a> folgt in der weiblichen Version denselben Gesetzen, und sich darauf vorzubereiten verändert alles. Und behalte eines im Kopf: Der Nebel, in dem du steckst, ist nicht dein natürlicher Zustand. Er ist gemacht. Du wirst deine Klarheit zurückbekommen, und wahrscheinlich schneller, als du denkst.</p>
<a href="/de/blog/narzisstischer-mann-anzeichen/" class="blog-read-also"><span class="blog-read-also-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></span><span class="blog-read-also-content"><span class="blog-read-also-label">Auch lesen</span><span class="blog-read-also-title">Narzisstischer Mann: 12 Anzeichen, vom öffentlichen Charme zur privaten Kontrolle</span></span><svg class="blog-read-also-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg></a>`,
    },
  ],
};
