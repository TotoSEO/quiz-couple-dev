...
<li><strong>Deine Belege:</strong> Nachrichten, Mails, Kontoauszüge, wenn Geld ein Kontrollfeld ist... gesichert außerhalb seiner Reichweite, bei jemandem oder in einem Konto, das er nicht kennt.</li>
...
<li><strong>Deine Aufzeichnung:</strong> Schreib für dich die sachliche Liste dessen auf, was dich hierhergebracht hat. Du wirst sie lesen, wenn du zweifelst... und dieser Moment kommt, er steht im Programm.</li>
</ul>
...
<p>Und bereite dich auf die Abfolge nach der Ankündigung vor, denn sie ist völlig vorhersehbar: zuerst Tränen und Versprechen, dann Wut, an dritter Stelle Schuldzuweisungen («du zerstörst alles», «nach allem, was wir erlebt haben»)... und manchmal Drohungen. Das ist kein Kummer, der sich ausdrückt, das ist ein System, das alle Türen testet, der Reihe nach. Diese <a href="/de/blog/narzisstischer-manipulator/">typischen Reaktionen des Manipulators</a> sind bemerkenswert vorhersehbar... und sie im Voraus zu kennen nimmt ihnen den größten Teil ihrer Macht.</p>`,
    },
    {
      ...
      content: `<p>Hier scheitern die meisten Trennungen, schauen wir dem Sturm also ins Gesicht. Er hat drei Akte, fast immer in dieser Reihenfolge.</p>`,
      subsections: [
        {
    ...
    },
    {
      ...
      content: `<p>Zwei Phänomene verwirren alle Betroffenen nach der Trennung, also nehmen wir sie gleich auseinander.</p>`,
      subsections: [
        {
...
<p class="blog-cta-texte">Eine Fragenreihe zieht Bilanz über deine Beziehung, was sie dir gibt, was sie dich kostet und wohin sie geht. Das Ergebnis entscheidet nicht für dich... es beleuchtet nur die Entscheidung, um die du seit Wochen kreist.</p>
...
<p>Das Letzte, was du wissen musst, ist vielleicht das Wichtigste: Der Ausstieg ist eine Bahn, kein Augenblick. Vielleicht gibt es eine Rückkehr, einen Rückfall, einen zweiten Aufbruch. Das nimmt dir nichts. Jede Zyklusrunde lehrt dich etwas, das die nächste nutzen wird, und eines Tages bleibt die Tür endgültig zu. Tausende Frauen waren genau dort. Es geht ihnen heute gut. Wirklich gut... und oft viel besser als vor ihm.</p>
