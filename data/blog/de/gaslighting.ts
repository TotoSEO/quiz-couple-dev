...
<p>Das Wort ist seit einigen Jahren überall, oft falsch verwendet, also bringen wir Präzision hinein: woher der Begriff kommt, wie der Mechanismus funktioniert, und wie man wieder Boden findet, wenn man drinsteckt. Denn man kommt heraus, und besser noch: mit einem eingebauten Detektor.</p>`,
  quickSummary: [
...
<p>Das Phänomen ist heute von der Psychologie dokumentiert und als Form psychischer Gewalt anerkannt. Manche nennen es treffend eine «kognitive Entführung». Genau das ist es: eine Entführung, die deines eigenen Urteils.</p>`,
    },
    {
      ...
      content: `<p>Gaslighting kommt nie auf einen Schlag, es steigert sich stufenweise. Hier sind sie der Reihe nach: das Ziel rückt mit jeder Stufe eine Ebene höher.</p>`,
      subsections: [
        {
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          content: `<p>Gaslighting braucht eine geschlossene Welt, in der seine Stimme die einzige Quelle ist. Öffne die Fenster wieder: Erzähle einer Vertrauensperson regelmäßig konkrete Szenen. Nicht, damit sie entscheidet, sondern damit du wieder hörst, wie Realität klingt, wenn niemand sie bestreitet.</p>`,
        },
        {
