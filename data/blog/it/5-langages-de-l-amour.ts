...
<p>Un trucco di ritmo: scegliete ciascuno UN gesto a settimana nella lingua dell'altro, uno solo, ma deliberato. Dopo un mese l'effetto è già lì. È lo stesso principio delle <a href="/it/blog/domande-per-conoscersi-meglio/">domande per conoscersi meglio</a>: la regolarità modesta batte il grande gesto.</p>`,
        },
      ],
    },
    {
...
<p>Perché è questo, in fondo, il vero regalo del concetto: non le etichette, ma la conversazione che innesca. Quella in cui ognuno spiega come ama e come si sente amato. Molte coppie non l'hanno mai avuta, quella conversazione. Adesso avete il pretesto perfetto!</p>
