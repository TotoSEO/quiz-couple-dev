...
<p>Solo che quel numero descrive l'auto. Non descrive l'inizio della storia. Perché un'altra indagine, anch'essa francese, mostra che <strong>il litigio è cominciato molto spesso diverse settimane prima, nella preparazione</strong>: il 47 % delle donne in coppia e il 38 % degli uomini dicono di aver già litigato con il partner sull'organizzazione delle vacanze.</p>

<p>Quindi no, non serve annullare! Ma vale davvero la pena sapere dove si rompe, perché quasi mai è dove si crede.</p>`,
  quickSummary: [
...
<p>Ecco perché le vacanze non creano i problemi: li rendono visibili, molto in fretta e tutti insieme.</p>`,
    },
    {
      id: 'i-numeri',
      title: `I 6 numeri, nell'ordine in cui arriva il litigio`,
      content: `<p>La cronologia conta più delle percentuali prese singolarmente. Ecco come si svolge, da maggio fino alla seconda settimana sul posto.</p>

<ol>
<li><p><strong>47 % delle donne, 38 % degli uomini:</strong> la quota di persone che hanno già litigato con il partner sull'organizzazione delle vacanze. È il primissimo punto di attrito, e arriva prima della prenotazione.</p></li>

<li><p><strong>Il 66 % delle donne dice di fare di più</strong> del partner nella preparazione, di cui il 43 % «molto di più». Di fronte, il 53 % degli uomini ritiene di aver partecipato in parti uguali, contro appena il 27 % delle donne. Non è un disaccordo sulle vacanze, è un disaccordo su cosa è successo.</p></li>

<li><p><strong>30 %:</strong> la quota di coppie che litiga sullo sforamento del budget. Un dato stabile, e l'unico che si risolve davvero con un foglio di calcolo.</p></li>

<li><p><strong>Il 28 % trova il tragitto teso.</strong> La scelta dell'itinerario e lo stile di guida sono in testa ai motivi, molto prima della stanchezza o dei figli.</p></li>

<li><p><strong>83 %:</strong> la quota di viaggi in cui una sola persona guida dall'inizio alla fine, quasi sempre un uomo. Circa una donna su tre dice di preferire non mettersi al volante per timore dei commenti del partner.</p></li>

<li><p><strong>49 %:</strong> una volta arrivati, quasi una persona su due ritiene che condividere uno spazio con i compagni di viaggio aumenti la probabilità di litigare.</p></li>
</ol>

<aside class="blog-tip-box">
<p class="blog-tip-box-title">📌 Da sapere</p>
<p>Nessuno di questi numeri misura la stessa cosa, ed è proprio questo il punto. Non si parla di una coppia che litiga una volta: si parla di quattro momenti distinti, a maggio, a giugno, in autostrada e dopo tre giorni di casa vacanze. Una coppia può superare i primi tre senza problemi ed esplodere al quarto.</p>
</aside>`,
    },
    {
...
<p>Guidare si vede. Aver pensato al libretto sanitario e alle scarpe di ricambio, no. È esattamente il terreno su cui un disaccordo che non si dice mai finisce per uscire su una cosa minuscola, di solito il casello o il navigatore.</p>`,
    ...
    {
      id: 'il-paradosso',
      title: `Il paradosso che spiega tutto il resto`,
      content: `<p>Questa è la statistica più divertente di tutto il dossier, e probabilmente la più utile.</p>

<p>In un'indagine condotta a marzo 2026 da Talker Research su 2 000 americani che viaggiano con i propri cari, <strong>il 73 % degli intervistati si considera il compagno di viaggio ideale</strong>. Facile da gestire, accomodante, mai un problema.</p>

<p>Nella stessa indagine, <strong>il 49 % ritiene che condividere uno spazio aumenti i litigi</strong>.</p>

<p>I due numeri non possono essere veri insieme. Se quasi tre persone su quattro sono perfette, da dove escono i litigi? Gli autori lo chiamano divario di compatibilità in viaggio: ognuno misura la propria flessibilità sulle intenzioni e quella dell'altro sui comportamenti.</p>

<div class="blog-verdict">
<div class="blog-verdict-col blog-verdict-col--oui">
<p class="blog-verdict-titre"><span aria-hidden="true">👍</span> I veri inneschi</p>
<ul>
<li><strong>Lo squilibrio nella preparazione</strong>, citato dal 40 % delle donne come primo motivo.</li>
<li><strong>Il budget che sfora</strong>, il 30 % delle coppie.</li>
<li><strong>La mancanza di spazio personale</strong>, una volta arrivati.</li>
<li><strong>Il ritmo</strong>: uno vuole cinque visite al giorno, l'altra vuole dormire.</li>
</ul>
</div>
<div class="blog-verdict-col blog-verdict-col--non">
<p class="blog-verdict-titre"><span aria-hidden="true">👎</span> Cosa viene accusato a torto</p>
<ul>
<li><strong>La destinazione</strong>, in causa solo per il 26 % degli intervistati.</li>
<li><strong>Il meteo</strong>, che serve soprattutto da pretesto a una tensione già presente.</li>
<li><strong>Il paese scelto</strong>: nessuna indagine seria mostra che una destinazione faccia litigare più di un'altra.</li>
<li><strong>Il fatto stesso di partire</strong>: il problema non è il viaggio, è ciò che il viaggio rivela.</li>
</ul>
</div>
</div>`,
    },
...
<p><strong>Bisogna partire ognuno per conto proprio?</strong><br>
...
<p>Sondaggio <a href="https://www.direct-assurance.fr/newsroom" target="_blank" rel="noopener">OpinionWay per Direct Assurance</a>, 1 016 persone dai 18 anni in su, 6 e 7 maggio 2025. Indagine <a href="https://www.voyageavecnous.fr/etude-ifop-charge-mentale-femmes-vacances/" target="_blank" rel="noopener">IFOP per Voyage avec Nous</a>, 1 099 persone in coppia, dal 22 al 24 giugno 2022. Studio <a href="https://talkerresearch.com/the-vacation-compatibility-gap/" target="_blank" rel="noopener">Talker Research per Club Wyndham</a>, 2 000 americani che viaggiano con i propri cari, dal 5 all'11 marzo 2026. Ricerca universitaria di <a href="https://www.sciencedirect.com/science/article/pii/S266695792400003X" target="_blank" rel="noopener">Coffey, Shahvali, Kerstetter e Aron</a>, <em>Annals of Tourism Research Empirical Insights</em>, 2024.</p>
</aside>`,
    },
  ],
};
