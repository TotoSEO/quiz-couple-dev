...
const article: BlogArticleData = {
  ...
  featuredImage: '',
  featuredImageAlt: "Dipendenza affettiva — comprendere i segnali e liberarsene",
...
<p>Ecco perché le persone con dipendenza affettiva possono restare in relazioni tossiche per anni. Non è debolezza. È che il vuoto che aspetta dall'altra parte fa più paura della sofferenza che vivono dentro.</p>`,
        },
        {
          id: 'paura-abbandono',
...
<p>Non è un compromesso di coppia — è una cancellazione. E il peggio è che di solito te ne rendi conto solo dopo la rottura, quando ti ritrovi di fronte a te stesso/a e scopri di non sapere più chi sei.</p>`,
        },
      ],
    },
    {
...
<p>Un giorno, l'altro se ne va (o tu, completamente esausto/a). E il ciclo ricomincia con qualcun altro. A volte peggio, perché ogni rottura rafforza la convinzione: "non sono abbastanza".</p>`,
    },
    {
...
<p>Meriti una relazione in cui sei libero/a. Non libero/a di andartene — libero/a di essere lì per scelta, non per paura del vuoto.</p>
