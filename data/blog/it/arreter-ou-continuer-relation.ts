...
const article: BlogArticleData = {
  slug: 'lasciarsi-o-continuare-coppia',
  title: `I segnali che dicono se lasciarsi o continuare una relazione`,
  metaTitle: `Coppia: come capire se lasciarsi o continuare?`,
  metaDescription: `Undici segnali che dicono di fermarsi, sette che dicono di continuare, e la domanda che li separa. Senza che nessuno decida al posto tuo.`,
...
<p>Non lo farò. <strong>Nessuno dall'esterno può decidere al posto tuo</strong>, e diffida di chi sostiene il contrario in otto punti. Quello che esiste, invece, sono segnali che tornano sempre, nelle coppie che si sono lasciate come in quelle che hanno tenuto. Conoscerli non decide per te, ma ti evita di girare in tondo per altri due anni.</p>`,
  quickSummary: [
    `La vera domanda non è «lo amo?» ma «mi piaccio ancora quando sono con questa persona?».`,
    `Undici segnali indicano un vicolo cieco: il disprezzo, la paura, l'isolamento e la scomparsa della riparazione sono i più decisivi.`,
    `Sette segnali dicono che vale la pena continuare, e il più affidabile è che vi arrabbiate ancora davvero.`,
    `Un brutto periodo ha una causa identificabile e una data d'inizio. Un vicolo cieco no.`,
    `Noia, routine e calo del desiderio non sono motivi di rottura in sé: sono sintomi, e si curano.`,
    `Se ci sono violenza, paura o controllo, la domanda non è più «lasciarsi o continuare» ma «come uscirne in sicurezza».`,
  ],
  sections: [
    {
...
<li><p><strong>Vi proiettate ancora, anche vagamente:</strong> un viaggio, una casa, un cane. Se il futuro contiene ancora due persone, non è finita.</p></li>
    ...
    {
      id: 'periodo-o-vicolo-cieco',
      title: `Brutto periodo o vicolo cieco: come distinguerli`,
      content: `<p>È la distinzione che conta di più e quella che si sbaglia più spesso, perché entrambe fanno male allo stesso modo.</p>

<table>
<thead>
<tr>
<th></th>
<th>Brutto periodo</th>
<th>Vicolo cieco</th>
</tr>
</thead>
<tbody>
<tr>
<td>Origine</td>
<td>Un evento identificabile</td>
<td>Impossibile da datare</td>
</tr>
<tr>
<td>Ciò che fa male</td>
<td>La situazione</td>
<td>La persona, o te stesso dentro la relazione</td>
</tr>
<tr>
<td>I litigi</td>
<td>Su un tema preciso</td>
<td>Sempre lo stesso, con pretesti diversi</td>
</tr>
<tr>
<td>Dopo il litigio</td>
<td>Qualcuno torna</td>
<td>Ciascuno si allontana un po' di più</td>
</tr>
<tr>
<td>Quando va meglio</td>
<td>Vi ritrovate</td>
<td>Convivete più tranquilli</td>
</tr>
<tr>
<td>L'idea di andarsene</td>
<td>Fa paura</td>
<td>Solleva</td>
</tr>
</tbody>
...
<li><strong>Lo stesso argomento ripreso dieci volte</strong>, con le stesse promesse e zero cambiamenti.</li>
    ...
    },
    {
      ...
      title: `Quando la domanda non è più quella giusta`,
      content: `<p>Ci sono situazioni in cui «lasciarsi o continuare» non è la cornice giusta, e in cui ragionare in termini di coppia diventa perfino pericoloso.</p>
...
<p>Quando la domanda pesa di più e la parola separazione è già sul tavolo, esiste anche un <a href="/it/test-devo-divorziare/">questionario costruito intorno alla decisione di divorziare</a>, con fasce di risultato pensate per quel momento.</p>`,
    },
    {
      id: 'se-decidi-di-continuare',
...
<p>E se decidi di smettere: non è un fallimento. Una relazione che finisce non è una relazione sbagliata. È durata quanto doveva durare, e in quel tempo sei stato qualcuno per qualcuno.</p>`,
    },
    {
      id: 'domande-frequenti',
      title: `Le domande che ci si pone in quel momento`,
      content: `<p><strong>Quanto tempo darsi prima di decidere?</strong><br>
Da tre a sei mesi, con un cambiamento concreto avviato fin dall'inizio. Sotto i tre mesi si misura un umore. Oltre l'anno senza che niente si muova, non stai aspettando una decisione, la stai evitando.</p>

<p><strong>Si può amare qualcuno e doverlo lasciare?</strong><br>
Sì, ed è anzi la situazione più frequente tra chi esita a lungo. L'amore non è mai bastato a rendere vivibile una relazione. La domanda utile non è «lo amo?», è «mi piaccio ancora quando sono con questa persona?».</p>

<p><strong>Bisogna parlarne al partner mentre si è ancora indecisi?</strong><br>
Nella maggior parte dei casi sì, ma non nella forma «sto pensando di lasciarti». Piuttosto: «non sto bene da un po' e voglio che ne parliamo». La prima frase innesca una crisi, la seconda apre una conversazione.</p>

<p><strong>E se il problema fossi io?</strong><br>
È una domanda onesta e merita di meglio di una risposta rassicurante. Il nostro modo di reagire al conflitto e alla distanza si gioca in buona parte nel <a href="/it/test-stile-attaccamento/">nostro stile di attaccamento</a>, che si osserva e si lavora. Molte persone rigiocano lo stesso copione di relazione in relazione senza accorgersene.</p>

<p><strong>I figli sono un motivo per restare?</strong><br>
Sono un motivo per fare le cose bene, non necessariamente per restare. La ricerca è piuttosto costante: ciò che danneggia i figli non è la separazione in sé, è il conflitto a cui assistono, prima come dopo.</p>`,
    },
    {
      id: 'per-finire',
      title: `Per finire`,
