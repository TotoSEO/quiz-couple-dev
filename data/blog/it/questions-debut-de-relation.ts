...
<li>Cosa ti appassiona al punto da parlarne per un'ora?</li>
<li>Sei più riflessivo o più impulsivo, e come si vede nel quotidiano?</li>
<li>Com'è il tuo rapporto con gli amici: gruppo unito, cerchie separate, pochi intimi?</li>
<li>Cosa ti fa ridere, ridere davvero?</li>
<li>Come ti alzi la mattina: col piede giusto o non-parlarmi-prima-del-caffè?</li>
<li>Qual è il viaggio che ti ha segnato, e cosa dice di te?</li>
<li>Cosa capiscono male di te a prima vista?</li>
<li>Cucini, o riscaldi con talento?</li>
<li>Qual è il tuo vizietto che ammetti a metà?</li>
<li>Cosa ti rilassa dopo una settimana pesante?</li>
<li>Sei l'ultimo ad arrivare o il primo ad andarsene, a una festa?</li>
<li>Qual è la cosa più spontanea che hai fatto ultimamente?</li>
<li>Cosa non indovinerei mai di te?</li>
</ol>`,
    },
    {
      id: 'con-le-settimane',
...
<li>Di quanto tempo per te hai bisogno in una settimana ideale?</li>
<li>Cosa ti mette davvero a disagio negli altri?</li>
<li>Qual è la tua definizione di un weekend riuscito?</li>
<li>Come reagisci quando ti fanno una critica, sinceramente?</li>
<li>Tieni i contatti col tuo passato, o volti pagina?</li>
<li>Qual è il tuo rapporto con la famiglia, la tua?</li>
<li>Cosa ti hanno già rimproverato... e tu cosa ne pensi?</li>
<li>Come funzioni in caso di disaccordo: discuti a caldo o dopo aver riflettuto?</li>
<li>Cos'è un bel gesto, per te: le parole, il tempo, le attenzioni?</li>
<li>Cosa ti fa ingelosire, se sei onesto?</li>
<li>Diresti che ti affezioni in fretta, o che lasci venire?</li>
<li>Qual è la cosa che può rovinare tutto per te in una relazione?</li>
<li>Cosa ti aspetti da qualcuno nei momenti brutti?</li>
</ol>
...
<li>Dove ti vedi geograficamente: città, campagna, altrove, nomade?</li>
<li>Qual è il tuo rapporto con i soldi: formica, cicala, o dipende?</li>
<li>I figli: un progetto, una domanda aperta o un no?</li>
<li>Cosa significa la fedeltà per te, concretamente?</li>
<li>Che posto dai alla tua famiglia nella tua vita di coppia?</li>
<li>Qual è il tuo rapporto con le feste, le tradizioni, magari la religione?</li>
<li>Credi che una coppia debba condividere tutto, o tenere dei giardini propri?</li>
<li>Come immagini la divisione del quotidiano in due?</li>
<li>Cos'è non negoziabile per te, in una frase?</li>
<li>Cosa pensi delle coppie che vivono ciascuno a casa propria?</li>
<li>Qual è la tua paura più grande in amore?</li>
<li>Cosa ti hanno insegnato le tue storie passate su ciò di cui hai bisogno?</li>
<li>E su ciò che non vuoi assolutamente più?</li>
</ol>`,
    },
    {
...
<li>Ci sono altre persone nel quadro che dovrei conoscere?</li>
<li>Qual è il tuo ritmo per ufficializzare le cose?</li>
<li>Cosa hai pensato di me dopo il primo appuntamento, la versione vera?</li>
<li>C'è un argomento che stai evitando con me, adesso?</li>
<li>Cosa ti farebbe scappare, così so dove metto i piedi?</li>
</ol>
<p>La 46 merita una menzione speciale: è LA domanda che nessuno fa e che tutti pagano. Due persone possono vivere due relazioni diverse per mesi, una esclusiva nella sua testa, l'altro no. Trenta secondi di coraggio risolvono la cosa definitivamente.</p>`,
    },
    {
...
<tr><td>«Perché è finita con la tua ex?»</td><td>Chiama una versione difensiva</td><td>Quando la fiducia permette una risposta vera</td></tr>
<tr><td>«Vuoi figli?»</td><td>Trasforma un inizio in un progetto di vita</td><td>Prima che l'attaccamento renda cara la risposta</td></tr>
<tr><td>«Stai vedendo qualcun altro?»</td><td>Posta come test, non rassicura mai</td><td>Posta in chiaro, quando vuoi davvero sapere</td></tr>
</tbody></table></div>`,
    },
    {
...
<p class="blog-cta-texte">Una serie di domande districa quello che provi davvero: attaccamento, attrazione, abitudine o amore nascente. Cinque minuti, e vedrai molto più chiaro il seguito.</p>
