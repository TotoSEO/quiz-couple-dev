...
const article: BlogArticleData = {
  slug: 'narcissistic-woman-signs',
  title: "The narcissistic woman: 10 signs men don't dare name",
  metaTitle: "Narcissistic woman: symptoms and typical masks",
...
<p>This article does the work in order: the masks first, because that's her signature. The 10 signs next, in concrete terms. And at the end, what you can do, because the goal isn't to slap a label on her, it's to get YOU out of the fog.</p>`,
  quickSummary: [
    ...
    "The hold works less through authority than through guilt-tripping and emotional control.",
    "Her ultimate weapon: credibility. If you talk, you're the villain.",
    "Men doubt twice: about what they're living, and about their right to suffer from it. That doubt is part of the system too.",
  ],
  sections: [
    {
      id: 'why-nobody-talks-about-it',
      title: "Why nobody ever talks about it (and why that suits her)",
      content: `<p>Let's start with the taboo, because it's part of the problem. A man who says his partner belittles him, controls him and makes him doubt his own sanity, what does he generally hear back? «She's got character!», «Aren't you being a bit dramatic?», or the great classic: «What did you do to get her into that state?»</p>
<p>The result: men keep quiet. And that silence isn't a detail, it's a playing field. <strong>A female manipulator knows perfectly well that her victim's word will count for less than hers.</strong> It is, as we're about to see, a central piece of her system.</p>
<p>Fundamentally, the pattern is identical to the one described in the guide to the <a href="/en/blog/narcissist-in-love-signs/">narcissist in love</a>: a structural need to dominate in order to exist, the other person used as fuel, the idealisation-devaluation-rejection cycle. What changes is the packaging, and it's worth the detour.</p>`,
    },
    {
      id: 'her-masks',
...
<tr><td>On social media</td><td>Ideal couple, declarations, knowing photos</td><td>The photo evening ended in a scene, but nobody will ever know that</td></tr>
<tr><td>During conflict</td><td>Moved, measured, «worried about you»</td><td>Contemptuous, cutting, then icy silence for days</td></tr>
</tbody></table></div>
<p>You see the trap: the day you want to describe what you're living, everyone around you will have met the public version. And that's what your word will have to fight against.</p>`,
    },
    {
      id: 'the-10-signs',
...
<p>That's normal: half of them already appear, in a less systematic version, in the <a href="/en/blog/red-flags-in-a-woman/">red flags in a woman</a>. The difference is intensity and coherence: an isolated red flag is a flaw. Ten red flags all converging on controlling and isolating you is a system.</p>
</aside>`,
    },
    {
...
<div class="blog-cta">
<p class="blog-cta-titre">Put calm words on what you're living</p>
<p class="blog-cta-texte">Twenty questions go through the concrete situations of this kind of relationship, in both directions: they apply to a female partner as much as a male one. Answer quietly, for yourself. Nobody will know.</p>
<a class="blog-cta-btn" href="/en/narcissistic-partner-test/">Take stock discreetly</a>
<p class="blog-cta-note">Free &middot; No sign-up &middot; Instant result</p>
</div>
<aside class="blog-tip-box">
<p class="blog-tip-box-title">⚠️ Helplines are for men too</p>
<p>It's often overlooked: several national domestic abuse helplines explicitly take calls from male victims, and psychological violence counts. Look up the one in your country, most are free and anonymous. If you're facing threats, control over your money or your movements, or physical violence «even once», call. A therapist who knows psychological abuse will walk the rest of the road with you.</p>
</aside>
<p>One last word about leaving: with this profile, a break-up doesn't look like a normal break-up. Spectacular win-back, smear campaign, cyclical returns. <a href="/en/blog/breaking-up-with-a-narcissist/">Breaking up with a narcissist</a> obeys the same laws in the female version, and preparing for it in advance changes everything. And keep one thing in mind: the fog you're in is not your natural state. It's a fabrication. You'll get your clarity back, and probably faster than you think.</p>
<a href="/en/blog/narcissistic-man-signs/" class="blog-read-also"><span class="blog-read-also-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></span><span class="blog-read-also-content"><span class="blog-read-also-label">Read also</span><span class="blog-read-also-title">Narcissistic man: 12 signs, from public charm to private control</span></span><svg class="blog-read-also-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg></a>`,
    },
  ],
};
