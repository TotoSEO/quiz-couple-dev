...
const article: BlogArticleData = {
  ...
  title: "Gaslighting: when you're made to doubt your own reality",
  metaTitle: "Gaslighting: recognising the manipulation that drives you mad",
...
<p>The word has been everywhere for a few years, often misused, so let's put some precision back: where the term comes from, how the mechanism works exactly, how to tell it apart from a simple disagreement about memories... and above all how to find your footing when you're in it. Because people do get out, and better: they get out with a built-in detector.</p>`,
  quickSummary: [
    ...
    "A disagreement about memories is normal; gaslighting is a SYSTEM, one-way and repeated.",
    "The ultimate weapon against it: writing. Dated records never doubt themselves.",
    "In many countries, repeated psychological abuse within a couple is a criminal offence. It isn't «in your head».",
  ],
  sections: [
    {
...
<tr><td>Faced with proof</td><td>«Oh yes, you're right!»</td><td>Concedes, grumbling</td><td>Still denies, or turns the proof against you</td></tr>
<tr><td>The effect on you</td><td>None, you laugh about it later</td><td>Irritation</td><td>Growing doubt about your own mind</td></tr>
<tr><td>The benefit for them</td><td>None</td><td>Winning the argument</td><td>Winning control of your reality</td></tr>
</tbody></table></div>
<p>The right-hand column is recognisable by its last row: gaslighting isn't a conversational incident, it's a power strategy. And that's why it sits at the heart of the <a href="/en/blog/narcissist-in-love-signs/">narcissist's functioning</a> in love: someone who controls your reality no longer needs to control you.</p>`,
    },
    {
...
<p>Not always, and the nuance matters. There's an «avoidance» gaslighting: someone who denies out of an inability to take responsibility, with no strategy... That's destructive too, but it can be confronted: faced with the effect produced, they can hear it and change. Strategic gaslighting survives every confrontation, proof included. As always, it's the reaction to proof that sorts it out.</p>
    ...
    {
      id: 'finding-your-footing',
      title: "Finding your footing: the anti-fog plan",
      content: `<p>Getting out of gaslighting means rebuilding direct access to your own reality, without going through him. Four moves, in order.</p>`,
      subsections: [
        {
        ...
        },
        {
          ...
          title: "Stop pleading your case",
          content: `<p>You'll never convince someone whose power depends precisely on not being convinced! Replace the pleadings with short statements: «we don't have the same memory, I'm keeping mine». That's all. Your reality doesn't need his visa.</p>`,
        },
        {
...
<div class="blog-cta">
<p class="blog-cta-titre">Your reality deserves a stocktake</p>
<p class="blog-cta-texte">Twenty questions run your relationship through the concrete situations of gaslighting and coercive control: the doubt, the versions, the silences, the control. A calm result, yours, that nobody can «renegotiate» with you.</p>
<a class="blog-cta-btn" href="/en/narcissistic-partner-test/">Check what I'm living through</a>
