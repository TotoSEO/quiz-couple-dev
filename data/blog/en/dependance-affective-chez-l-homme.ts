...
const article: BlogArticleData = {
  slug: 'emotional-dependency-in-men',
  title: "Emotional dependency in men: the love-sickness nobody sees",
  metaTitle: "Emotional dependency in men: the specific signs",
  metaDescription: "Jealousy, anger, need for control, back-to-back relationships... Male emotional dependency doesn't look like the cliché, and that's why we miss it.",
...
<tr><td>Anger as a lightning rod</td><td>A difficult temperament</td><td>A pain with no other way out</td></tr>
<tr><td>The perfect guy</td><td>An irreproachable partner</td><td>A worth that has to be bought back daily</td></tr>
<tr><td>Never single</td><td>Someone lucky in love</td><td>The emptiness he never wants to cross</td></tr>
