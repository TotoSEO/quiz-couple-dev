...
const article: BlogArticleData = {
  ...
  featuredImage: '',
  featuredImageAlt: "Emotional dependency — understanding the signs and breaking free",
...
<p>This is why emotionally dependent people can stay in toxic relationships for years. It's not weakness. It's that the emptiness waiting on the other side is scarier than the pain they're living through.</p>`,
        },
        {
...
<p>This isn't relationship compromise — it's erasure. And the worst part is that you usually only realize it after the breakup, when you're face to face with yourself and discover you no longer know who you are.</p>`,
        },
      ],
    },
    {
...
<p>Eventually, they leave (or you do, completely drained). And the cycle starts over with someone new. Sometimes worse, because each breakup reinforces the belief: "I'm not enough."</p>`,
    },
    {
...
<p>You deserve a relationship where you're free. Not free to leave — free to be there by choice, not out of fear of the void.</p>
