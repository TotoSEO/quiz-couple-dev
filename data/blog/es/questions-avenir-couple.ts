...
<li>¿Cómo repartimos las tareas: por ganas, por planning, por habilidades?</li>
<li>¿Cuál es tu ritmo ideal: trasnochador, madrugador, y cómo se negocia eso?</li>
<li>Invitar a amigos sin avisar: ¿normal o impensable?</li>
<li>¿Cómo gestionamos los gastos del día a día, desde el primer mes?</li>
<li>¿Cuál es tu peor angustia de convivencia?</li>
<li>¿Qué espacio propio necesitas en una casa?</li>
<li>Pantallas en el dormitorio: ¿sí, no, depende?</li>
<li>¿Cómo gestionamos un desacuerdo cuando ya no podemos irnos cada uno a su casa?</li>
<li>Ciudad o afueras, alquilar o comprar: ¿cuál es tu escenario ideal?</li>
...
<li>Matrimonio: ¿ganas, indiferencia o principio? ¿Y por qué?</li>
<li>¿Cuál es tu mayor miedo al comprometerte conmigo?</li>
<li>¿Qué haría de nosotros una pareja mayor lograda, dentro de cuarenta años?</li>
...
<li>¿Cómo te imaginas nuestros fines de semana dentro de diez años?</li>
<li>¿Qué han hecho mal las parejas casadas de tu alrededor, según tú?</li>
...
<p>La 20 y la 26 merecen una noche entera para ellas solas. Y cuando hayáis hecho el recorrido, el <a href="/es/test-compatibilidad-matrimonio/">test «listos para el matrimonio»</a> pone vuestras respuestas cara a cara, negro sobre blanco, y es sorprendente lo que se descubre.</p>`,
    ...
    {
      id: 'antes-de-un-hijo',
      title: "Antes de un hijo (31-45)",
      content: `<p>El tema más comprometedor de todos, y aquel en que lo no dicho cuesta más caro. Estas preguntas no se hacen de una sentada, pero todas deben haberse hecho antes del gran salto.</p>
<ol start="31">
<li>Un hijo: ¿es un proyecto con fecha, una idea difusa o una pregunta abierta?</li>
<li>¿Por qué quieres un hijo? La respuesta de verdad, no la social.</li>
<li>¿Y si no llegara de forma natural... qué haríamos, hasta dónde?</li>
<li>¿Quién reduce qué, en los primeros años: trabajo, salidas, sueño?</li>
...
<li>¿Cómo definimos un «gasto grande» que se habla entre los dos?</li>
<li>La diferencia de sueldos entre nosotros, ¿cómo la gestionamos, sin tabúes?</li>
<li>¿Qué deuda o compromiso financiero tuyo debería conocer?</li>
<li>Ahorrar ¿para qué, prioritariamente: casa, viajes, seguridad, jubilación?</li>
...
<li>¿Qué queremos haber vivido juntos antes de los 60?</li>
<li>¿Cuál es nuestro próximo gran proyecto, el que lanzamos este año?</li>
<li>Y dentro de muchísimo tiempo... ¿de qué te gustaría que se acordaran de nosotros?</li>
</ol>
...
<tr><td>Antes de un hijo</td><td>Quién frena su carrera y durante cuánto tiempo</td></tr>
<tr><td>El dinero</td><td>La relación con el gasto, heredada de cada familia</td></tr>
<tr><td>Los sueños comunes</td><td>Los que se han dejado de decir en voz alta</td></tr>
</tbody></table></div>
