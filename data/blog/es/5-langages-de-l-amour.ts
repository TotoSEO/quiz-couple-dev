...
<p>Un truco de ritmo: elegid cada uno UN gesto por semana en el idioma del otro, uno solo, pero deliberado. Al cabo de un mes el efecto ya está ahí. Es el mismo principio que las <a href="/es/blog/preguntas-para-conoceros-mejor/">preguntas para conoceros mejor</a>: la regularidad modesta gana al gran gesto.</p>`,
        },
      ],
    },
    {
...
<p>Porque eso es, en el fondo, el verdadero regalo del concepto: no las etiquetas, sino la conversación que provoca. Aquella en la que cada uno explica cómo quiere y cómo se siente querido. Muchas parejas nunca han tenido esa conversación. ¡Ahora tenéis la excusa perfecta!</p>
