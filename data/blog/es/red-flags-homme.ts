...
<tr><td>Sus actos no coinciden con sus palabras</td><td>Dice lo que hay que decir. Hace lo que quiere.</td><td>Vigilar</td></tr>
<tr><td>Te hace sentir culpable de sus estados de ánimo</td><td>Responsabilización emocional abusiva.</td><td>Serio</td></tr>
<tr><td>Habla mal de todas sus ex</td><td>En su versión de los hechos, nunca tiene la culpa. Nunca.</td><td>Vigilar</td></tr>
...
<tr><td>Ocupa todo el espacio sin dejar ninguno</td><td>Sus necesidades siempre van primero. Las tuyas, después.</td><td>Vigilar</td></tr>
    ...
    },
    {
      ...
      content: `<p>Aquí es donde suele empezar. No con un comportamiento espectacular, sino con una forma de interactuar que te deja regularmente con una sensación extraña. Agotada, confundida, o con la vaga impresión de ser "demasiado".</p>`,
      subsections: [
        {
...
<p>Gestionas su humor. Él no gestiona el suyo. Esa es una carga mental y emocional que cargas sola, y si lo señalas, siempre estás "quejándote de todo".</p>`,
      ...
      subsections: [
        {
          ...
          content: `<p>Dice que le importas, pero cancela sistemáticamente. Dice que eres importante, pero desaparece cuando lo necesitas. Dice que va a cambiar, y nada cambia. <strong>Observa lo que hace, no lo que dice.</strong> Las palabras no cuestan nada. Los actos revelan las prioridades reales.</p>`,
        },
        {
          id: 'no-respeta-limites',
          title: "No respeta lo que le has dicho claramente",
          content: `<p>Has puesto un límite. Lo has expresado con claridad, con calma, sin ambigüedad. Lo ha cruzado de todas formas. Quizás una vez, quizás con regularidad, quizás minimizándolo ("vaya tontería"). Los límites no son sugerencias. Un hombre que no los respeta no te respeta a ti.</p>`,
        },
        {
          id: 'ex-todas-locas',
    ...
    },
    {
      ...
      content: `<p>Estas son las más difíciles de identificar porque implican patrones relacionales, no actos aislados. Solo puedes verlas tomando perspectiva sobre la relación en su conjunto, no sobre un episodio concreto.</p>`,
      subsections: [
        {
