...
const article: BlogArticleData = {
  slug: 'mujer-narcisista-senales',
  title: "La mujer narcisista: 10 señales que los hombres no se atreven a nombrar",
  metaTitle: "Mujer narcisista: síntomas y máscaras típicas",
...
<p>Este artículo hace el trabajo por orden: primero las máscaras, porque son su firma. Luego las 10 señales, en versión concreta. Y al final, lo que puedes hacer, porque el objetivo no es ponerle una etiqueta a ella, es sacarte a TI de la niebla.</p>`,
  quickSummary: [
    ...
    "El dominio pasa menos por la autoridad que por la culpabilización y el control afectivo.",
    "Su arma definitiva: la credibilidad. Si hablas, el verdugo eres tú.",
    "Los hombres dudan dos veces: de lo que viven y de su derecho a sufrirlo. Esa duda también forma parte del sistema.",
  ],
  sections: [
    {
      id: 'por-que-nadie-habla-de-ello',
      title: "Por qué nunca se habla de esto (y por qué a ella le viene bien)",
      content: `<p>Empecemos por el tabú, porque forma parte del problema. Un hombre que cuenta que su pareja lo rebaja, lo controla y le hace dudar de su salud mental, ¿qué suele oír como respuesta? «¡Tiene carácter!», «¿No estás siendo un poco dramático?», o el gran clásico: «¿Qué has hecho tú para ponerla así?»</p>
<p>Resultado: los hombres se callan. Y ese silencio no es un detalle, es un terreno de juego. <strong>Una manipuladora sabe perfectamente que la palabra de su víctima valdrá menos que la suya.</strong> Es incluso, como veremos, una pieza central de su sistema.</p>
<p>En el fondo, el funcionamiento es idéntico al que se describe en la guía del <a href="/es/blog/narcisista-en-el-amor/">narcisista en el amor</a>: una necesidad estructural de dominar para existir, el otro usado como combustible, el ciclo idealización-devaluación-rechazo. Lo que cambia es el envoltorio, y merece el rodeo.</p>`,
    },
    {
      id: 'sus-mascaras',
...
<tr><td>En redes</td><td>Pareja ideal, declaraciones, fotos cómplices</td><td>La noche de las fotos acabó en crisis, pero eso no lo sabrá nadie</td></tr>
<tr><td>En un conflicto</td><td>Conmovida, comedida, «preocupada por ti»</td><td>Despectiva, hiriente, y luego silencio glacial durante días</td></tr>
</tbody></table></div>
<p>Ves la trampa: el día en que quieras contar lo que vives, todo tu entorno habrá conocido la versión pública. Y es contra ELLA contra la que tendrá que pelear tu palabra.</p>`,
    },
    {
      id: 'las-10-senales',
...
<p>Normal: la mitad ya aparecen, en versión menos sistemática, en las <a href="/es/blog/red-flags-en-una-mujer/">red flags en una mujer</a>. La diferencia es de intensidad y de coherencia: una red flag aislada es un defecto. Diez red flags que convergen en tu control y tu aislamiento son un sistema.</p>
</aside>`,
    },
    {
...
<div class="blog-cta">
<p class="blog-cta-titre">Pon palabras tranquilas a lo que vives</p>
<p class="blog-cta-texte">Veinte preguntas repasan las situaciones concretas de este tipo de relación, en los dos sentidos: valen para una pareja mujer y para una pareja hombre. Responde con calma, para ti. Nadie se enterará.</p>
<a class="blog-cta-btn" href="/es/test-pareja-narcisista/">Hacer balance discretamente</a>
<p class="blog-cta-note">Gratis &middot; Sin registro &middot; Resultado inmediato</p>
</div>
<aside class="blog-tip-box">
<p class="blog-tip-box-title">⚠️ Los recursos también son para los hombres</p>
<p>En España el 016 atiende la violencia contra las mujeres; si eres un hombre que sufre violencia en la pareja, los servicios de atención psicológica de tu comunidad autónoma son el primer recurso, y el 112 en caso de peligro inmediato. La violencia psicológica cuenta, y un psicólogo con formación en violencia en la pareja hará el resto del camino contigo.</p>
</aside>
<p>Una última cosa sobre la salida: con este perfil, la ruptura no se parece a una ruptura normal. Reconquista espectacular, campaña de desprestigio, vueltas cíclicas. La <a href="/es/blog/ruptura-con-un-narcisista/">ruptura con un narcisista</a> obedece a las mismas leyes en femenino, y prepararse de antemano lo cambia todo. Y ten una cosa en mente: la niebla en la que estás no es tu estado natural. Es una fabricación. Vas a recuperar tu nitidez, y probablemente antes de lo que crees.</p>
<a href="/es/blog/hombre-narcisista-senales/" class="blog-read-also"><span class="blog-read-also-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></span><span class="blog-read-also-content"><span class="blog-read-also-label">Leer también</span><span class="blog-read-also-title">Hombre narcisista: 12 señales, del encanto público al control privado</span></span><svg class="blog-read-also-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg></a>`,
    },
  ],
};
