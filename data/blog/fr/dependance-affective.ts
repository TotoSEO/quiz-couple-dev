...
const article: BlogArticleData = {
  ...
  featuredImage: '',
  featuredImageAlt: "Dépendance affective — comprendre les signes et s'en libérer",
...
<p>C'est pour ça que les personnes dépendantes affectives peuvent rester dans des relations toxiques pendant des années. Ce n'est pas de la faiblesse. C'est que le vide qui attend derrière fait plus peur que la souffrance qu'elles vivent dedans.</p>`,
        },
        {
          id: 'peur-abandon',
...
<p>Ce n'est pas un compromis de couple — c'est un effacement. Et le pire, c'est que tu ne t'en rends souvent compte qu'après la rupture, quand tu te retrouves face à toi-même et que tu réalises que tu ne sais plus qui tu es.</p>`,
        },
      ],
    },
    {
...
<p>Et à partir de là, chaque relation devient une course pour garder l'autre. Pas pour être heureux(se). Pour ne pas être abandonné(e).</p>`,
        },
      ],
    },
    {
...
<p>Un jour, l'autre finit par partir (ou toi, à bout). Et le cycle recommence avec quelqu'un d'autre. Parfois en pire, parce que chaque rupture renforce la croyance : « je ne suis pas suffisant(e) ».</p>`,
    },
    {
...
<p>Ce tableau n'est pas là pour te culpabiliser. Il est là pour te donner une grille de lecture. Si tu te reconnais dans la colonne de gauche, ce n'est pas une condamnation — c'est un point de départ.</p>`,
    },
    {
...
<p>Tu mérites une relation où tu es libre. Pas libre de partir — libre d'être là par choix, pas par peur du vide.</p>
