...
const article: BlogArticleData = {
  ...
  introduction: `<p>Il y a l'homme que les autres voient : drôle, attentionné, brillant en société. Et il y a celui que tu retrouves une fois la porte fermée : celui qui souffle le chaud et le froid, qui retourne chaque dispute contre toi, qui te fait douter de ta propre mémoire. Le décalage entre les deux est tellement énorme que tu n'oses même plus en parler autour de toi. Qui te croirait ?</p>
<p><strong>C'est exactement ça, vivre avec un pervers narcissique : un doute permanent, installé par quelqu'un d'autre, que tu finis par prendre pour le tien.</strong> Et c'est pour ça que tu tapes cette recherche à 23 heures au lieu de dormir : tu ne cherches pas une définition, tu cherches à savoir si c'est ça que tu vis.</p>
<p>Alors on va faire les choses dans cet ordre-là. D'abord poser ce qu'est réellement un pervers narcissique, sans jargon et sans fantasme. Ensuite regarder à quoi ça ressemble de l'intérieur d'un couple, parce que c'est là que tout se joue. Et enfin te donner des moyens concrets de trancher, parce que rester dans le doute, c'est exactement ce que le mécanisme attend de toi.</p>`,
  quickSummary: [
...
<p>Et ça ressemble, surtout, à ta propre transformation. Tu te surprends à préparer tes phrases avant de lui parler, à t'excuser par réflexe, à te trouver nulle alors que tes collègues te trouvent solide. <strong>Quand une relation te fait rétrécir, le problème n'est pas ta taille.</strong></p>`,
    },
    {
      ...
      content: `<p>Une relation d'emprise ne s'installe pas d'un coup, elle suit un cycle bien documenté, en trois temps.</p>
<p><strong>L'idéalisation d'abord.</strong> Un début d'histoire irréel : messages permanents, déclarations très tôt, projets immédiats, le sentiment d'avoir enfin rencontré quelqu'un qui te comprend entièrement. Cette phase mérite un décryptage à elle seule, c'est exactement le <a href="/blog/love-bombing/">love bombing et ses trois phases</a> : elle sert à créer l'attachement avant l'esprit critique.</p>
<p><strong>La dévaluation ensuite.</strong> Le regard qui s'éteint, les critiques qui commencent par « c'est pour ton bien », les comparaisons, les silences punitifs. Rarement un basculement net : plutôt un thermostat qu'on baisse degré par degré, si lentement que tu t'adaptes au froid sans le remarquer.</p>
<p><strong>Le rejet, enfin, ou la menace du rejet.</strong> Il te laisse, ou te laisse croire qu'il va le faire, et te voilà en train de te battre pour reconquérir quelqu'un qui te maltraite. Et quand tu commences vraiment à te détacher, l'idéalisation revient comme par miracle : promesses, larmes, le retour de l'homme des débuts. Le cycle repart pour un tour, un peu plus court et un peu plus violent que le précédent, et la <a href="/blog/rupture-pervers-narcissique/">rupture avec un pervers narcissique</a> devient chaque fois plus difficile à tenir.</p>`,
    },
    {
...
<p>Tu coches la colonne de droite et le mot « pervers narcissique » te paraît encore trop gros ? Peu importe le mot. Une relation qui produit ces effets-là est au minimum une <a href="/blog/relation-toxique-signes/">relation toxique</a>, et ça suffit largement à justifier la suite de cet article.</p>`,
    },
    {
      ...
      content: `<p>Tout cet article est écrit au masculin par simplicité, mais la perversion narcissique n'a pas de sexe. Les mécanismes sont identiques ; l'habillage change.</p>
<p>Chez un homme, l'emprise s'appuie plus souvent sur l'autorité et la disqualification frontale ; on détaille ses schémas dans les <a href="/blog/homme-pervers-narcissique-signes/">signes de l'homme pervers narcissique</a>. Chez une femme, elle passe plus volontiers par la culpabilisation, le statut de victime et le contrôle affectif, des visages qu'on décrypte dans les <a href="/blog/femme-perverse-narcissique-signes/">signes de la femme perverse narcissique</a>, et les hommes qui le vivent osent encore moins en parler.</p>
<p>Dans les deux cas, l'expérience de la victime est la même : le doute, l'épuisement, l'isolement, et cette impression de devenir quelqu'un d'autre.</p>`,
    },
    {
      id: 'est-ce-qu-il-aime',
      title: "Est-ce qu'il t'aime ? Est-ce qu'il peut changer ?",
      content: `<p>Ce sont les deux questions qui retiennent le plus longtemps dans ce genre de relation, alors elles méritent des réponses honnêtes.</p>
<p><strong>Est-ce qu'il t'aime ?</strong> Il a besoin de toi, ce qui ressemble à de l'amour vu de l'intérieur. Mais il a besoin de toi comme fonction : régulateur d'image, fournisseur d'admiration, coupable de service. La question la plus utile n'est pas de savoir ce qu'il ressent, tu n'auras jamais accès à cette réponse. C'est : <em>est-ce que la manière dont il t'aime te fait du bien ?</em> Celle-là, tu peux y répondre seule.</p>
<p><strong>Est-ce qu'il peut changer ?</strong> Un trouble narcissique profond évolue rarement, et jamais sous la contrainte d'un ultimatum amoureux. Le piège n'est pas d'espérer un changement, c'est de payer pendant des années le prix d'un espoir que rien n'alimente, à part les redémarrages du cycle. Son éventuel travail sur lui-même est son chantier. Ta protection, c'est le tien.</p>`,
    },
    {
