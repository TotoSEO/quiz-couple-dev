...
<p>Sur le fond, le fonctionnement est identique à celui qu'on décrit dans le guide du <a href="/blog/pervers-narcissique-amour/">pervers narcissique en amour</a> : un besoin structurel de dominer pour exister, l'autre utilisé comme carburant, le cycle idéalisation-dévaluation-rejet. Ce qui change, c'est l'habillage... et il vaut le détour.</p>`,
    },
    {
      id: 'les-masques',
...
<p>Un dernier mot sur la sortie : avec ce profil, la rupture ne ressemble pas à une rupture normale. Reconquête spectaculaire, campagne de dénigrement, retours cycliques... prépare-toi en lisant la <a href="/blog/rupture-pervers-narcissique/">rupture avec un pervers narcissique</a>, les mécanismes sont les mêmes au féminin. Et garde une chose en tête : le brouillard dans lequel tu es n'est pas ton état naturel. C'est une fabrication. Tu vas retrouver ta netteté, et probablement plus vite que tu ne le crois.</p>
