...
const article: BlogArticleData = {
  slug: 'femme-perverse-narcissique-signes',
  title: "La femme perverse narcissique : 10 signes que les hommes n'osent pas nommer",
  metaTitle: "Pervers narcissique femme : symptômes et masques typiques",
...
<p>On commence par ses masques, parce que c'est sa signature, puis on passe aux 10 signes en version concrète. Le but n'est pas de mettre une étiquette sur elle... c'est de te sortir du brouillard, toi.</p>`,
  quickSummary: [
    ...
    "L'emprise passe moins par l'autorité que par la culpabilisation et le contrôle affectif.",
    "Son arme ultime : la crédibilité. Si tu parles, c'est toi le bourreau.",
    "Les hommes doutent deux fois : de ce qu'ils vivent, et de leur droit d'en souffrir. Ce doute-là aussi fait partie du système.",
  ],
  sections: [
    {
      id: 'pourquoi-personne-n-en-parle',
      title: "Pourquoi on n'en parle jamais (et pourquoi ça l'arrange)",
      content: `<p>Commençons par le tabou, parce qu'il fait partie du problème. Un homme qui raconte que sa compagne le rabaisse, le contrôle et le fait douter de sa santé mentale... s'entend répondre quoi, en général ? « Elle a du caractère ! », « T'es pas un peu dramatique ? », ou le grand classique : « Qu'est-ce que t'as fait pour la mettre dans cet état ? »</p>
<p>Résultat : les hommes se taisent. Et ce silence n'est pas un détail, c'est un terrain de jeu. <strong>Une manipulatrice sait parfaitement que la parole de sa victime vaudra moins que la sienne.</strong> C'est même, on va le voir, une pièce centrale de son système.</p>
<p>Sur le fond, le fonctionnement est identique à celui qu'on décrit dans le guide du <a href="/blog/pervers-narcissique-amour/">pervers narcissique en amour</a> : un besoin structurel de dominer pour exister, l'autre utilisé comme carburant, le cycle idéalisation-dévaluation-rejet. Ce qui change, c'est l'habillage, et il mérite qu'on s'y arrête.</p>`,
    },
    {
      id: 'les-masques',
...
<tr><td>Sur les réseaux</td><td>Couple idéal, déclarations, photos complices</td><td>La soirée photo s'est finie en crise... mais ça, personne ne le saura</td></tr>
<tr><td>En cas de conflit</td><td>Émue, mesurée, « inquiète pour toi »</td><td>Méprisante, cinglante, puis silence glacial pendant des jours</td></tr>
</tbody></table></div>
<p>Tu vois le piège : le jour où tu voudras raconter ce que tu vis, tout ton entourage aura rencontré la version publique. Et c'est contre ELLE que ta parole devra se battre...</p>`,
    },
    {
      id: 'les-10-signes',
      title: "Les 10 signes, version concrète",
      content: `<p>Comme toujours avec ce profil, aucun signe isolé ne prouve rien. C'est l'accumulation, la répétition, et le sens général qui comptent. Dans ses formes féminines typiques, ça donne ceci.</p>
<ol>
<li><strong>La culpabilisation comme langue maternelle :</strong> Aucun ordre, jamais. Des soupirs, des « vas-y, amuse-toi bien » qui veulent dire l'inverse, des « c'est bon, j'ai l'habitude d'être seule ». Tu finis par renoncer de toi-même, et c'est le principe même : elle n'interdit rien, elle rend tout coûteux.</li>
...
<p>Normal : la moitié figurent déjà, en version moins systématique, dans les <a href="/blog/red-flags-femme/">red flags chez une femme</a>. La différence est d'intensité et de cohérence : un red flag isolé est un défaut. Dix red flags qui convergent vers ton contrôle et ton isolement, c'est un système.</p>
</aside>`,
    },
    {
      id: 'ce-que-ca-fait-a-un-homme',
      title: "Ce que ça fait à un homme, de l'intérieur",
      content: `<p>Et il faut le dire : les hommes sous emprise développent les mêmes symptômes que les femmes victimes. Le doute permanent, l'autocensure, la vigilance épuisante, la honte, avec une couche en plus : le sentiment de ne pas avoir le droit de se plaindre. « Je suis un homme, je devrais gérer. »</p>
...
<div class="blog-cta">
<p class="blog-cta-titre">Mets des mots posés sur ce que tu vis</p>
<p class="blog-cta-texte">Vingt questions passent en revue les situations concrètes de ce genre de relation, dans les deux sens : elles valent pour une compagne comme pour un compagnon. Réponds tranquillement, pour toi. Personne n'en saura rien.</p>
<a class="blog-cta-btn" href="/test-pervers-narcissique/">Faire le point discrètement</a>
<p class="blog-cta-note">Gratuit &middot; Sans inscription &middot; Résultat immédiat</p>
</div>
<aside class="blog-tip-box">
<p class="blog-tip-box-title">⚠️ Le 3919, c'est aussi pour les hommes</p>
<p>On l'ignore souvent : le 3919, numéro national des violences conjugales, écoute aussi les hommes victimes, et les violences psychologiques en font partie. Gratuit, anonyme. Si tu subis menaces, contrôle de ton argent ou de tes déplacements, ou de la violence physique « même une fois »... appelle. Un psy au fait des violences psychologiques fera le reste du chemin avec toi.</p>
</aside>
<p>Un dernier mot sur la sortie : avec ce profil, la rupture ne ressemble pas à une rupture normale. Reconquête spectaculaire, campagne de dénigrement, retours cycliques : la <a href="/blog/rupture-pervers-narcissique/">rupture avec un pervers narcissique</a> obéit aux mêmes lois au féminin, et s'y préparer à l'avance change tout. Et garde une chose en tête : le brouillard dans lequel tu es n'est pas ton état naturel. C'est une fabrication. Tu vas retrouver ta netteté, et probablement plus vite que tu ne le crois.</p>
<a href="/blog/homme-pervers-narcissique-signes/" class="blog-read-also"><span class="blog-read-also-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></span><span class="blog-read-also-content"><span class="blog-read-also-label">Lire aussi</span><span class="blog-read-also-title">Homme pervers narcissique : 12 signes, du charme public au contrôle privé</span></span><svg class="blog-read-also-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg></a>`,
    },
  ],
};
