...
<p>Une précision importante, quand même : tout le monde sort une de ces phrases un jour de fatigue. Ce qui signe un manipulateur, c'est le répertoire : la variété des formules, leur retour systématique, et le fait qu'au bout du compte, ce soit toujours toi qui t'excuses. Ce fonctionnement d'ensemble, c'est celui du <a href="/blog/pervers-narcissique-amour/">pervers narcissique en amour</a> : la phrase n'est qu'un rouage du système.</p>`,
    },
    {
      id: 'inverser-la-faute',
      title: "Famille n°1 : inverser la faute",
      content: `<p>La spécialité maison. Tu arrives avec un reproche, tu repars avec un tort.</p>
<ul>
<li><strong>« C'est de ta faute si je suis comme ça. »</strong> Le classique absolu. Sa colère, ses écarts, son ton : tout devient une réaction à toi. Traduction réelle : « je refuse de porter la responsabilité de mes actes ».</li>
...
<li><strong>« Tu vois, c'est exactement ça le problème avec toi. »</strong> Prononcée au milieu d'une dispute, elle transforme UN désaccord en preuve d'un défaut permanent. Tu n'as plus un tort ponctuel, tu as une nature défaillante.</li>
    ...
    {
      id: 'te-faire-douter',
      title: "Famille n°2 : te faire douter de ce que tu as vu",
      content: `<p>Celle-ci porte un nom, le gaslighting, et c'est la plus corrosive à long terme. Son but : que tu ne fasses plus confiance à ta propre mémoire.</p>
<ul>
<li><strong>« Je n'ai jamais dit ça. »</strong> Dit avec un aplomb parfait, y compris quand tu as la preuve. L'objectif n'est pas de te convaincre sur ce point précis : c'est de t'apprendre que contester ne sert à rien.</li>
...
<li><strong>« Tu devrais consulter, sérieusement. »</strong> La plus violente de la famille. Ta lucidité devient une pathologie. Et le jour où tu consultes vraiment, un bon psy voit clair très vite, et c'est d'ailleurs pour ça qu'il déteste cette idée en pratique.</li>
</ul>
<p>Si ce brouillage te parle, prends le temps de comprendre <a href="/blog/gaslighting/">comment le gaslighting s'installe</a>, parce qu'il ne se limite pas à des phrases.</p>`,
    ...
    {
      id: 'se-victimiser',
      title: "Famille n°3 : se poser en victime",
      content: `<p>Le manipulateur a un talent particulier pour souffrir plus fort que toi, au moment exact où tu souffres.</p>
<ul>
...
<li><strong>« Vas-y, dis que je suis un monstre pendant que tu y es. »</strong> L'exagération défensive : il pousse ton reproche jusqu'à l'absurde pour que tu passes ton tour. Tu voulais parler d'un retard, te voilà en train de jurer qu'il n'est pas un monstre.</li>
    ...
    {
      id: 'te-devaloriser-en-douceur',
      title: "Famille n°4 : te rabaisser sans en avoir l'air",
      content: `<p>Rarement des insultes, ce serait trop visible. Plutôt des petites phrases qui liment, l'air de rien, avec le sourire.</p>
<ul>
<li><strong>« Je dis ça pour ton bien. »</strong> Le passe-partout qui transforme n'importe quelle critique en cadeau. Refuser le « cadeau », c'est être ingrate.</li>
...
<p>Ces phrases visent presque toujours tes points forts, pas tes faiblesses. Ton travail, ton humour, ton indépendance, ce qui te rend fière. Un partenaire maladroit critique ce que tu rates. Un manipulateur s'en prend à ce qui te tient debout, et c'est toute la différence.</p>
    ...
    {
      id: 'te-faire-taire-et-t-isoler',
      title: "Familles n°5 et 6 : te faire taire, puis te couper des autres",
      content: `<p>Les deux dernières familles travaillent ensemble. D'abord fermer la conversation avec toi, ensuite fermer les conversations avec les autres.</p>
<p>Pour te faire taire :</p>
<ul>
...
<p>L'écrit est ta meilleure protection contre le « je n'ai jamais dit ça ». Garde les conversations, fais des captures datées, stocke-les hors de ton téléphone si tu peux. Si un jour tu as besoin d'y voir clair, ou de prouver quoi que ce soit, ces traces vaudront de l'or.</p>
    ...
    {
      id: 'comment-repondre',
      title: "Comment répondre à ces phrases (sans y laisser ta soirée)",
      content: `<p>Règle d'or : <strong>ne te justifie pas sur le cadre, reviens au fond.</strong> Chaque minute passée à prouver que tu n'es pas « trop sensible » est une minute gagnée pour lui. Voici à quoi ça ressemble en pratique.</p>
<div><table><thead><tr><th>Il dit...</th><th>Évite</th><th>Essaie plutôt</th></tr></thead><tbody>
<tr><td>« Tu es trop sensible. »</td><td>« Non c'est faux, je ne suis pas trop sensible, la preuve... »</td><td>« Peut-être. Et le rendez-vous d'hier, on en parle quand ? »</td></tr>
<tr><td>« Je n'ai jamais dit ça. »</td><td>Ressortir les preuves une par une</td><td>« On ne va pas débattre de ça. Moi je l'ai entendu, et voilà l'effet que ça m'a fait. »</td></tr>
<tr><td>« C'est de ta faute si je suis comme ça. »</td><td>« Mais qu'est-ce que j'ai fait ?! »</td><td>« Chacun est responsable de ses réactions. Des miennes aussi. »</td></tr>
<tr><td>« Après tout ce que j'ai fait pour toi... »</td><td>Lister ce que toi tu as fait</td><td>« Ce n'est pas un concours. Là, je te parle d'un truc précis. »</td></tr>
<tr><td>« Calme-toi. »</td><td>Se calmer en s'excusant</td><td>« Je suis calme. Et j'attends toujours ta réponse. »</td></tr>
</tbody></table></div>
<p>Tu remarqueras le principe : des phrases courtes, factuelles, qui refusent le terrain proposé. Pas de plaidoirie ! La plaidoirie est ce qu'il attend, parce qu'elle valide que ta légitimité était bien le sujet.</p>
