...
const article: BlogArticleData = {
  slug: 'micro-tromperie',
  title: "La micro-tromperie : ces petites infidélités qui n'en sont pas (ou si ?)",
  metaTitle: "Micro-tromperie : où commence l'infidélité en 2026",
...
<p>Alors mettons de l'ordre dans la zone grise : ce qui relève vraiment de la micro-tromperie, ce qui n'en est pas, pourquoi ça fait si mal alors que « il ne s'est rien passé »... et comment en parler sans passer pour la jalouse de service. Parce que oui, tu as le droit d'en parler.</p>`,
  quickSummary: [
    "La micro-tromperie : des transgressions sous la ligne rouge, qui installent de l'ambiguïté avec un tiers.",
    "Le critère n'est pas l'acte, c'est le secret : ce qu'on masque, minimise ou efface... on sait pourquoi.",
    "Tout n'est pas micro-tromperie : l'amitié, les likes anodins et les collègues existent.",
    "Sa vraie gravité : pas ce qui s'est passé, mais ce qui est en train de se construire.",
    "La réponse n'est ni la surveillance ni le silence : c'est la conversation sur VOS lignes à vous.",
  ],
  sections: [
    {
