...
const article: BlogArticleData = {
  slug: 'dependance-affective-chez-l-homme',
  title: "La dépendance affective chez l'homme : le mal d'amour que personne ne voit",
  metaTitle: "Dépendance affective chez l'homme : les signes spécifiques",
...
<p>Cet article fait ce que les autres ne font pas : décrire la dépendance affective version homme, avec ses vrais visages. Si tu es un homme et que tu lis ça, accroche-toi, il y a des chances que ça pique un peu. Et si tu es une femme qui reconnaît son compagnon... la fin de l'article est aussi pour toi.</p>`,
  quickSummary: [
    ...
    "La mécanique de fond est la même que chez les femmes : l'autre régule ton état interne.",
    "Le tabou aggrave tout : un homme « en demande », socialement, ça ne se dit pas.",
    "Ça se travaille exactement pareil... à condition d'accepter d'abord de le nommer.",
  ],
  sections: [
    {
...
<p>Contrôle du téléphone, des sorties, des vêtements, isolement de l'autre... La dépendance affective masculine, non traitée, peut glisser vers des comportements qui ne relèvent plus du « mal d'amour » mais du contrôle coercitif, et ce glissement-là fait des victimes. Si tu te reconnais dans cette pente, c'est maintenant qu'il faut agir, pas après la prochaine crise.</p>
</aside>
<div><table><thead><tr><th>Le masque</th><th>Ce que l'entourage voit</th><th>Ce qu'il y a dessous</th></tr></thead><tbody>
<tr><td>La jalousie de contrôle</td><td>Un mec possessif</td><td>La terreur de ne pas compter assez</td></tr>
<tr><td>La colère paratonnerre</td><td>Un caractère difficile</td><td>Une peine qui n'a pas d'autre sortie</td></tr>
<tr><td>Le mec parfait</td><td>Un partenaire irréprochable</td><td>Une valeur qui se rachète chaque jour</td></tr>
