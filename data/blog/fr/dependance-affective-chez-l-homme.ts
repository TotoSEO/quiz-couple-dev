...
<p>Le pire ? Ce départ « confirme » sa croyance de départ : on finit toujours par m'abandonner. Et le voilà reparti pour un tour, avec la suivante, en pire. C'est exactement ce cercle que les <a href="/blog/dependance-affective-symptomes/">symptômes classiques du manque affectif</a> alimentent en silence... tant que personne ne le nomme.</p>`,
    },
    {
      ...
      content: `<p>La méthode de fond est la même pour tout le monde, et on l'a détaillée exercice par exercice dans <a href="/blog/sortir-de-la-dependance-affective/">sortir de la dépendance affective</a> : stabiliser, se réapproprier sa vie, consolider. Mais il y a trois spécificités masculines qui changent la donne, et autant les dire cash.</p>
