...
const article: BlogArticleData = {
  ...
  metaDescription: "Tu fais tout, lui rien. Ou presque. Pourquoi certains hommes arrêtent de faire des efforts, comment le reconnaître, quoi en penser et quoi faire concrètement.",
  featuredImage: '',
  ...
  introduction: `<p>Tu organises, tu anticipes, tu penses à tout. Les sorties, les cadeaux, les moments ensemble, les discussions importantes. Et lui, il est là, il répond quand tu proposes, il participe quand tu insistes, mais rien ne vient vraiment de lui. Tu as l'impression de <a href="/test-couple-sain/">porter la relation à bout de bras</a> depuis un moment, et tu commences à te demander si c'est normal, si tu demandes trop, ou si quelque chose ne va pas vraiment.</p>
