...
const article: BlogArticleData = {
  slug: 'gaslighting',
  title: "Gaslighting : quand on te fait douter de ta propre réalité",
  metaTitle: "Gaslighting : reconnaître la manipulation qui rend fou",
...
<p>Le mot est partout depuis quelques années, souvent à tort et à travers, alors remettons de la précision : d'où vient le terme, comment le mécanisme fonctionne, et comment reprendre pied quand on est dedans. Parce qu'on en sort, et mieux : on en sort avec un détecteur intégré.</p>`,
  quickSummary: [
    "Le gaslighting attaque ta perception, pas les faits : c'est toi qu'on conteste, pas la scène.",
    "Le mécanisme monte en 3 temps : nier les faits, disqualifier ton ressenti, pathologiser ta personne.",
    "Un désaccord de souvenirs est normal ; le gaslighting est un SYSTÈME, à sens unique et répété.",
    "L'arme absolue contre lui : l'écrit. Les traces datées ne doutent jamais d'elles-mêmes.",
    "En France, ces violences psychologiques répétées sont punies par la loi. Ce n'est pas « dans ta tête ».",
  ],
  sections: [
    {
...
<p>Le phénomène est aujourd'hui documenté par la psychologie, reconnu comme forme de violence psychologique, et au Québec, on le nomme joliment « détournement cognitif ». C'est exactement ça : un détournement, celui de ton propre jugement.</p>`,
    },
    {
      ...
      content: `<p>Le gaslighting ne débarque jamais d'un coup, il monte en puissance par paliers. Les voici dans l'ordre : la cible monte d'un cran à chaque palier.</p>`,
      subsections: [
        {
          id: 'temps-1-nier-les-faits',
          title: "Temps 1 : nier les faits",
          content: `<p>« Je n'ai jamais dit ça. » « Tu confonds. » « Ce n'est pas ce qui s'est passé. » À ce stade, on conteste la scène, pas encore toi. C'est déstabilisant, mais tu peux encore répondre sur le terrain des faits, et c'est d'ailleurs pour ça que ça ne s'arrête pas là.</p>`,
        },
        {
...
<p>Ajoute à ça le recrutement de témoins, « même ta sœur trouve que tu débloques en ce moment », et le brouillage est total : ta réalité est devenue minoritaire dans ta propre vie.</p>`,
    ...
    },
    {
      ...
      title: "Gaslighting, mensonge ou simple mauvaise foi ? Le tableau qui tranche",
      content: `<p>Précision indispensable, parce que le mot est utilisé à toutes les sauces : NON, tout désaccord de souvenirs n'est pas du gaslighting ! Deux personnes de bonne foi se rappellent différemment la même soirée, c'est même la norme. Voici comment faire le tri.</p>
<div><table><thead><tr><th></th><th>Désaccord normal</th><th>Mauvaise foi ordinaire</th><th>Gaslighting</th></tr></thead><tbody>
<tr><td>La cible</td><td>Les faits (« je croyais que... »)</td><td>Les faits, pour éviter un tort</td><td>TOI : ta mémoire, ta perception</td></tr>
<tr><td>La fréquence</td><td>Ponctuel, dans les deux sens</td><td>Dans les moments de conflit</td><td>Systématique, à sens unique</td></tr>
<tr><td>Face à une preuve</td><td>« Ah oui, tu as raison ! »</td><td>Concède en râlant</td><td>Nie encore, ou retourne la preuve contre toi</td></tr>
<tr><td>L'effet sur toi</td><td>Aucun, on en rit après</td><td>De l'agacement</td><td>Un doute croissant sur ta propre tête</td></tr>
<tr><td>Le bénéfice pour l'autre</td><td>Aucun</td><td>Gagner la dispute</td><td>Gagner le contrôle de ta réalité</td></tr>
</tbody></table></div>
<p>La colonne de droite se reconnaît à sa dernière ligne : le gaslighting n'est pas un incident de conversation, c'est une stratégie de pouvoir. Et c'est pour ça qu'on le retrouve au cœur du <a href="/blog/pervers-narcissique-amour/">fonctionnement du pervers narcissique</a> en amour : quelqu'un qui contrôle ta réalité n'a plus besoin de te contrôler, toi.</p>`,
    },
    {
...
<p>Pas toujours, et la nuance compte. Il existe un gaslighting « d'évitement » : quelqu'un qui nie par incapacité à assumer, sans stratégie. C'est destructeur aussi, mais ça se confronte : mis face à l'effet produit, il peut entendre et changer. Le gaslighting stratégique, lui, survit à toutes les confrontations, preuves comprises. Comme toujours, c'est la réaction à la preuve qui fait le tri.</p>
</aside>`,
    },
    {
      id: 'reprendre-pied',
      ...
      subsections: [
        ...
        },
        {
          ...
          content: `<p>Le gaslighting a besoin d'un monde fermé où sa voix est la seule source. Rouvre les fenêtres : raconte des scènes précises à une personne de confiance, régulièrement. Pas pour qu'elle tranche, mais pour réentendre le son que fait la réalité quand quelqu'un ne la conteste pas.</p>`,
        },
        {
