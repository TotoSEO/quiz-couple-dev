...
<p>Alors préparons. Ce qui se joue avant la rupture, pendant, et surtout après, parce que c'est après que tout se décide. Si tu lis ça en pleine hésitation, garde une chose en tête : tu n'as pas à être sûre à 100 % pour te préparer. Se préparer n'engage à rien... et ça change tout le jour où tu décides.</p>`,
  quickSummary: [
    ...
    "Après : reconquête, puis dénigrement, puis retours cycliques. Prévisible, donc gérable.",
    "Le no contact n'est pas de la dureté, c'est un sevrage. Et il a des règles précises.",
    "Le retour vers les ex fait partie du système : s'il revient, ce n'est pas de l'amour, c'est du carburant.",
  ],
  sections: [
    {
      id: 'avant-preparer-en-silence',
      title: "Avant : préparer en silence",
      content: `<p>Première règle, contre-intuitive : ne pas annoncer la couleur. Pas d'ultimatums répétés, pas de « si ça continue je pars », pas de rupture brandie en argument de dispute. Chaque fausse alerte l'entraîne... et affaiblit la vraie. Pendant que tu hésites tout haut, il ajuste sa stratégie.</p>
<p>À la place, prépare concrètement, discrètement :</p>
<ul>
<li><strong>Tes appuis.</strong> Reconnecte deux ou trois personnes de confiance, mets-les au courant, même partiellement. Tu auras besoin d'un regard extérieur quand il lancera la machine à doute.</li>
<li><strong>Tes traces.</strong> Messages, mails, relevés si l'argent est un terrain de contrôle... sauvegardés hors de portée, chez quelqu'un ou sur un compte à toi qu'il ne connaît pas.</li>
<li><strong>Ta logistique.</strong> Où dormir les premières semaines, quoi emporter, comment sécuriser tes papiers et tes comptes. Plus la sortie est organisée, moins la panique décide à ta place.</li>
<li><strong>Ton récit.</strong> Écris, pour toi, la liste factuelle de ce qui t'a menée là. Tu la reliras au moment où tu douteras... et ce moment viendra, c'est prévu au programme.</li>
</ul>
...
<p>Et n'oublie pas de traiter l'autre moitié du problème : le manque. Si couper te semble insurmontable, ce n'est pas parce qu'il est irremplaçable... c'est parce que le cycle a créé un attachement de type addictif, souvent doublé d'une <a href="/blog/dependance-affective/">dépendance affective bien installée</a>. Le plan de sortie complet, sécurité comprise, se trouve dans <a href="/blog/sortir-emprise-pervers-narcissique/">sortir de l'emprise</a>... et il se travaille très bien accompagnée.</p>
<div class="blog-cta">
<p class="blog-cta-titre">Encore en train d'hésiter ? C'est normal, et ça se mesure</p>
<p class="blog-cta-texte">Une série de questions fait le point sur ta relation, ce qu'elle te donne, ce qu'elle te coûte, et où elle va. Le résultat ne décide pas à ta place... il éclaire juste la décision que tu tournes en rond à éviter.</p>
<a class="blog-cta-btn" href="/test-est-ce-la-fin-de-mon-couple/">Faire le point sur ma décision</a>
<p class="blog-cta-note">Gratuit &middot; Sans inscription &middot; Résultat immédiat</p>
</div>
<p>La dernière chose à savoir, c'est peut-être la plus importante : la sortie est une trajectoire, pas un instant. Il y aura peut-être un retour, une rechute, un deuxième départ... Ça ne t'enlève rien. Chaque tour de cycle t'apprend quelque chose que le suivant utilisera, et un jour, la porte reste fermée pour de bon. Des milliers de femmes sont exactement passées par là. Elles vont bien, aujourd'hui. Vraiment bien... et souvent bien mieux qu'avant lui.</p>
