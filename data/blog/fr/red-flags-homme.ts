...
<tr><td>Il souffle le chaud et le froid</td><td>Instabilité émotionnelle ou manipulation consciente.</td><td>À surveiller</td></tr>
<tr><td>Ses actes ne collent pas avec ses mots</td><td>Il dit ce qu'il faut dire. Il fait ce qu'il veut faire.</td><td>À surveiller</td></tr>
<tr><td>Il te fait sentir coupable de ses humeurs</td><td>Responsabilisation émotionnelle abusive.</td><td>Sérieux</td></tr>
<tr><td>Il parle mal de toutes ses ex</td><td>Dans son histoire, il n'a jamais tort. Jamais.</td><td>À surveiller</td></tr>
<tr><td>Il ne respecte pas tes limites</td><td>Il teste jusqu'où il peut aller. Et il continue.</td><td>Sérieux</td></tr>
<tr><td>Il est charmant en public, différent en privé</td><td>Deux versions. Une pour les autres, une pour toi.</td><td>Très sérieux</td></tr>
<tr><td>Il prend de la place sans en laisser</td><td>Ses besoins passent toujours en premier. Les tiens, après.</td><td>À surveiller</td></tr>
</tbody></table></div>`,
    },
    {
      id: 'red-flags-emotionnels',
      title: "Les red flags émotionnels",
      content: `<p>C'est là que ça commence, en général. Pas avec un comportement spectaculaire, mais avec une façon d'interagir qui te laisse régulièrement avec un sentiment bizarre. Épuisée, confuse, ou avec l'impression vague d'être "trop".</p>`,
      subsections: [
        {
...
<p>Tu gères son humeur. Il ne gère pas la sienne. C'est une charge mentale et émotionnelle que tu portes seule, et si tu le signales, tu es "toujours à te plaindre".</p>`,
    ...
    },
    {
      ...
      subsections: [
        {
          id: 'actes-vs-mots',
          title: "Ses actes ne correspondent pas à ses mots",
          content: `<p>Il dit qu'il tient à toi, mais il annule systématiquement. Il dit que tu comptes, mais il disparaît quand tu as besoin de lui. Il dit qu'il va changer, et rien ne change. <strong>Observe ce qu'il fait, pas ce qu'il dit.</strong> Les mots coûtent rien. Les actes, eux, révèlent les priorités réelles.</p>`,
        },
        {
          id: 'ne-respecte-pas-limites',
          title: "Il ne respecte pas ce que tu lui as dit clairement",
          content: `<p>Tu as posé une limite. Tu l'as exprimée clairement, calmement, sans ambiguïté. Il l'a franchie quand même. Peut-être une fois, peut-être régulièrement, peut-être en la minimisant ("c'est quoi ce caprice"). Les limites ne sont pas des suggestions. Un homme qui ne les respecte pas ne te respecte pas.</p>`,
        },
        {
          id: 'ex-toutes-folles',
    ...
    },
    {
      ...
      content: `<p>Ces red flags-là sont les plus difficiles à identifier parce qu'ils concernent des patterns relationnels, pas des actes isolés. Tu ne peux les voir qu'en prenant du recul sur l'ensemble de la relation, pas sur un épisode particulier.</p>`,
      subsections: [
        {
        ...
        {
          id: 'doutes-de-toi',
          title: "Tu doutes de toi depuis que tu es avec lui",
          content: `<p>C'est peut-être le signal le plus révélateur. Tu avais confiance en toi avant. Tu savais ce que tu voulais, ce que tu valais. Et là, tu passes du temps à te demander si tu es "trop" ci ou "pas assez" ça, si tu réagis normalement, si tu es raisonnable. Cette érosion de l'estime de soi n'arrive pas par hasard. Elle se construit, commentaire après commentaire, minimisation après minimisation.</p>`,
        },
      ],
    },
    {
