...
const article: BlogArticleData = {
  ...
  title: "Symptômes de la dépendance affective : ce que ça fait vivre, concrètement",
...
<p>On va les passer en revue un par un, sphère par sphère : ce qui se passe dans ta tête, dans ton couple, dans ton corps, et avec les autres. Pas pour te coller une étiquette, hein. Juste pour t'aider à voir clair... parce que ce fonctionnement se travaille très bien, une fois qu'on l'a identifié.</p>`,
  quickSummary: [
    ...
    "Aimer fort n'est pas un symptôme. Avoir peur en permanence, si.",
    "Le corps parle aussi : boule au ventre, sommeil en vrac, épuisement de vigilance.",
    "C'est la fréquence et la souffrance qui font le diagnostic, pas un épisode isolé.",
  ],
  sections: [
    {
      id: 'symptome-central',
...
<p>Penser à lui souvent, détester les longues absences, avoir besoin de contact : c'est l'attachement normal d'une histoire qui compte. La ligne se franchit quand il y a de la peur en permanence, de la souffrance récurrente, et l'impression de ne plus t'appartenir. C'est l'intensité de la détresse qui fait le symptôme, pas l'intensité de l'amour.</p>
</aside>`,
    },
    {
      id: 'dans-ton-corps',
...
<li><strong>Tu choisis toujours le même profil :</strong> Distant, insaisissable, tiède... et te voilà à nouveau en train de courir. Ce n'est pas de la malchance : l'insécurité cherche ce qu'elle connaît. Et quand le partenaire distant est aussi un manipulateur, le cocktail devient franchement dangereux : le duo <a href="/blog/dependant-affectif-et-manipulateur/">dépendant affectif et manipulateur</a> transforme ta peur de l'abandon en outil de contrôle sur mesure.</li>
    ...
    {
      id: 'a-partir-de-quand-s-inquieter',
...
<a class="blog-cta-btn" href="/test-dependance-affective/">Évaluer ma situation</a>
<p class="blog-cta-note">Gratuit &middot; Sans inscription &middot; Résultat immédiat</p>
</div>`,
    },
    {
      id: 'questions-frequentes',
      title: "Questions fréquentes sur les symptômes de la dépendance affective",
      content: `<p>Trois réponses courtes aux questions qui reviennent le plus.</p>`,
      subsections: [
        {
        ...
        },
        {
          ...
          title: "Peut-on être dépendant affectif et heureux en couple ?",
          content: `<p>Par périodes, oui, surtout avec un partenaire stable et rassurant. Mais le fond reste fragile : la sérénité dépend du comportement de l'autre, pas de toi. À la première zone de turbulence, une distance, un conflit, un doute, les symptômes reviennent. C'est pour ça que le vrai travail se fait sur ta sécurité intérieure, pas sur le choix du « bon » partenaire.</p>`,
        },
        {
