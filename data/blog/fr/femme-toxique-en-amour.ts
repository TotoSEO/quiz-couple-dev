...
const article: BlogArticleData = {
  ...
  title: "Femme toxique en amour : les signes que les hommes mettent trop de temps à voir",
...
<p>Une femme exigeante, entière, avec du tempérament, peut être un excellent partenaire : le caractère se discute, s'ajuste, s'assume. Le toxique, lui, se reconnaît à trois choses : ça se répète, ça ne se remet jamais en question... et c'est toujours toi qui t'adaptes. Si tes limites déclenchent l'escalade au lieu du dialogue, tu as changé de catégorie.</p>
    ...
    },
    {
      ...
      content: `<p>Les signes les plus fiables, tu commences à connaître la musique, ne sont pas chez elle : ils sont chez toi. Tu marches sur des œufs. Tu racontes de moins en moins ta relation à tes potes, parce que tu sais ce qu'ils diraient... Tu t'excuses par réflexe. Tu as renoncé à des pans entiers de ta vie sans te souvenir d'avoir décidé. Et surtout, tu as ce réflexe typiquement masculin : tu minimises. « Ça va, c'est pas l'enfer non plus. »</p>
...
<p>Dernier mot pour celui qui a reconnu sa compagne dans cet article : la marche à suivre est la même que dans l'autre sens. Nommer le comportement précisément, une fois, calmement. Poser une limite. Observer ce qu'elle en fait sur trois mois, des actes, pas des promesses... Et si la limite déclenche systématiquement l'escalade, relis les <a href="/blog/relation-toxique-signes/">signes d'une relation toxique</a> : la section « est-ce que ça se répare » te concerne directement. Tu mérites une relation où poser une limite ne coûte rien. Oui, toi aussi.</p>
