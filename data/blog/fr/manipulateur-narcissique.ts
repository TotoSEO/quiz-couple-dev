...
<p>On va donc voir, dans l'ordre : ses techniques préférées, ses vulnérabilités réelles, ce que produit ton silence sur lui, et ses réactions types quand on lui résiste. Pas pour jouer au plus malin avec lui, on va le redire plus bas... mais parce que comprendre la mécanique, c'est déjà ne plus être dedans.</p>`,
  quickSummary: [
    ...
    "Ses points faibles sont réels : l'indifférence sincère, les témoins, l'écrit, et le temps.",
    "Ton silence le prive de carburant, mais attention : il déclenche d'abord une escalade.",
    "Démasqué, il ne s'effondre pas : il nie, contre-attaque ou se victimise. Prévisible, donc gérable.",
  ],
  sections: [
    {
...
<p>Dernier point, important : le silence dont on parle ici, c'est celui de la sortie de relation, le fameux no contact. À l'intérieur du couple, se taire pour « lui faire comprendre » ne fonctionne pas : il lit ce silence comme une punition, donc comme une réaction, donc comme du carburant. Encore une fois... c'est le jeu qu'il connaît le mieux.</p>`,
    },
    {
      ...
      title: "Comment il réagit quand on lui résiste : les scénarios types",
      content: `<p>Bonne nouvelle : sur ce terrain-là, le manipulateur narcissique est d'une prévisibilité remarquable. Voici les situations classiques, et ce qui se passe réellement derrière.</p>
<div><table><thead><tr><th>Situation</th><th>Sa réaction typique</th><th>Ce que ça signifie</th></tr></thead><tbody>
<tr><td>Tu le démasques ouvertement</td><td>Déni total, puis contre-attaque (« c'est toi la manipulatrice »), puis victimisation</td><td>Aucune introspection possible : l'accusation menace son image, il défend l'image</td></tr>
<tr><td>Tu poses une limite ferme</td><td>Test immédiat de la limite, punition froide, puis surenchère de charme</td><td>Il vérifie si la limite est un vrai mur ou une porte mal fermée</td></tr>
<tr><td>Tu ne réagis plus à ses provocations</td><td>Escalade des provocations, puis recherche d'un autre public</td><td>Sans réaction, pas de carburant : il augmente la dose avant de changer de source</td></tr>
